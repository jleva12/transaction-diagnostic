...
import {
    ArrowRightStartOnRectangleIcon, ChevronUpIcon, Cog6ToothIcon,
    Cog8ToothIcon, HomeIcon,
    InboxIcon,
    LightBulbIcon,
    MagnifyingGlassIcon, MegaphoneIcon, QuestionMarkCircleIcon,
                        ...
                        <Dropdown>
                            ...
                            <span className="flex min-w-0 items-center gap-3">
                              ...
                              <span className="min-w-0">
                                <span
                                    className="block truncate text-sm/5 font-medium text-zinc-950 dark:text-white">Erica</span>
